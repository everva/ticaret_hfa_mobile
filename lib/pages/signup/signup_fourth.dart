...
class SignupPageFourth extends StatefulWidget {
  @override
  _SignupPageFourthState createState() => _SignupPageFourthState();
}

class _SignupPageFourthState extends State<SignupPageFourth> {
  TextField textField;
  double width90 = 0;
  ...
  TextField getField() {
    textField = TextField(
      ...
      decoration: InputDecoration(
          labelText: 'CEP TELEFON NUMARASI',
